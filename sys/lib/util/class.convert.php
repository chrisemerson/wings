<?php
  ...
  class Convert {
    ...
    //These have built-in functions - may as well use them

    public static function DEG2RAD ($decValue) {
      return deg2rad($decValue);
    }//function

    public static function RAD2DEG ($decValue) {
      return rad2deg($decValue);
    }//function
  }//class
