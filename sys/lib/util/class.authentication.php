<?php
  ...
  class Authentication {
    ...
    public function attemptLogin ($strUsername, $strPassword, $blnRememberMe = false, $blnRedirectAfterLogin = true) {
      $strCollectionName = "\\Wings\\Collections\\" . $this->strUserModel . 'Collection';
    ...
    public function getCurrentUser () {
      if ($this->isLoggedIn()) {
        $strUserModel = "\\Wings\\Models\\" . $this->strUserModel;
    ...
    public function clearAllRememberedLogins ($intUserID = 0) {
      if ($this->blnRememberedLoginsEnabled) {
        if (!empty($intUserID) || (isset($this->objSession->currentuserid) && !empty($this->objSession->currentuserid))) {
          ...
          $strCollectionName = "\\Wings\\Collections\\" . $this->strRememberedLoginsModel . 'Collection';
    ...
    private function rememberLoginAtThisLocation () {
      if ($this->blnRememberedLoginsEnabled && $this->isLoggedIn()) {
        ...
        $strRememberedLoginsModel = "\\Wings\\Models\\" . $this->strRememberedLoginsModel;
