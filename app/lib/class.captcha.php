<?php
 ...
 class Captcha {
  ...
  private function loadFonts () {
   $this->arrFonts = $this->getFilesInDirectory($this->strFontDirectory);
  }//function

  private function loadBackgrounds () {
   $arrBackgrounds = $this->getFilesInDirectory($this->strBackgroundImagesDirectory);
  ...
  private function getFilesInDirectory ($strDirectoryName) {
   $arrFiles = array();
